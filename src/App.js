  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 mb-6">
        <div className="flex flex-col md:flexRow gap-4 items-center justify-between">
          <div>
...
export default function AsistenteProfesor() {
  ...
  // FUNCIÓN CORREGIDA - DEBE funcionar
  const abrirModalSuscripcion = () => {
    console.log("🔓 Abriendo modal de suscripción - FUNCIÓN EJECUTADA");
    setMostrarSuscripcion(true);
    trackEvent('modal_suscripcion_abierto');
  };
  ...
  const { 
    ...
    esVistaDisponible,
    activarSuscripcion
  } = usePremium(usuario, clases, abrirModalSuscripcion); // ← Pasar la función como tercer parámetro
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      {/* BOTÓN TEMPORAL DE PRUEBA - ELIMINAR LUEGO */}
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* (El resto del código de las vistas se mantiene igual) */}
